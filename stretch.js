...
{
exerciseName: "Wrist Wake-Up",
icon: "🤲",
instructions: [
"Rotate your wrists slowly in both directions.",
"Stretch your fingers wide, then gently relax your hands.",
"Shake out tension from your hands and forearms."
]
},
{
exerciseName: "Neck Release",
icon: "🙂",
instructions: [
"Tilt your head gently side to side without forcing it.",
"Roll your neck slowly and release upper-neck tension.",
"Take a breath and soften your jaw and shoulders."
]
}
]
},
...
{
exerciseName: "Shoulder Ease",
icon: "🌿",
instructions: [
"Lift and lower your shoulders slowly three times.",
"Roll your shoulders back and open your chest gently.",
"Breathe deeply and let your upper body soften."
]
},
{
exerciseName: "Calm Reset",
icon: "✨",
instructions: [
"Stand tall and take 3 slow breaths.",
"Stretch your arms upward and gently lengthen your spine.",
"Relax your shoulders and release tension through your neck."
]
}
]
},
...
{
exerciseName: "Upper Back Opener",
icon: "🪑",
instructions: [
"Clasp your hands in front of you and round your upper back gently.",
"Stretch between your shoulder blades and breathe deeply.",
"Relax your arms and roll your shoulders back."
]
},
{
exerciseName: "Neck & Wrist Reset",
icon: "🖐️",
instructions: [
"Gently stretch your neck from side to side.",
"Rotate your wrists and shake out your hands.",
"Release tension from your shoulders and forearms."
]
},
{
exerciseName: "Posture Refresh",
icon: "🌞",
instructions: [
"Stand tall and open your chest.",
"Reach your arms overhead and lengthen your spine.",
"Take a slow breath and reset your posture."
]
}
]
},
...
{
exerciseName: "Deep Desk Recovery",
icon: "🧍",
instructions: [
"Reach overhead, then fold forward gently if comfortable.",
"Roll up slowly and stretch your shoulders and upper back.",
"Take a deep breath and fully release desk tension."
]
},
{
exerciseName: "Complete Reset",
icon: "🌈",
instructions: [
"Stretch your neck, shoulders, wrists, and spine one by one.",
"Stand tall and breathe deeply as you release full-body tension.",
"Use this moment to fully reset before returning to work."
]
}
]
}
...
const selectedExercise = getRandomItem(config.exercises) || config.exercises[0];

totalDuration = config.durationSeconds;
remainingSeconds = config.durationSeconds;

if (titleEl) titleEl.textContent = config.title;
if (subtitleEl) titleEl.textContent && (subtitleEl.textContent = config.subtitle);

if (exerciseNameEl) exerciseNameEl.textContent = selectedExercise.exerciseName;
if (stretchTextEl) {
stretchTextEl.textContent = getRandomItem(selectedExercise.instructions) || "";
}
if (stretchIconEl) stretchIconEl.textContent = selectedExercise.icon || "🙆";
...
...defaults,
particleCount,
origin: { x: Math.random() * 0.3 + 0.1, y: Math.random() * 0.8 + 0.1 }
});

confetti({
...defaults,
particleCount,
origin: { x: Math.random() * 0.3 + 0.6, y: Math.random() * 0.8 + 0.1 }
});
